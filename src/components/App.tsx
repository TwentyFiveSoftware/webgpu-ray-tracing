			...
			<div className="flex min-h-svh items-center justify-center p-6 w-full">
				<Card className="max-w-[850px]">
					...
					<CardContent className="whitespace-wrap break-all">
						More information on support/availability of WebGPU and potentially
						how to enable it can be found at {}
						<a className="underline" href="https://caniuse.com/webgpu">
	...
	return (
		<div className="flex flex-col min-h-svh items-center justify-center gap-6 p-6 w-full">
			...
			<canvas
				ref={canvasRef}
				className={cn(
					"w-full h-auto bg-card aspect-video rounded-xl max-w-[1200px]",
					!isRendering ? "hidden" : "",
				)}
			/>
			...
			{isRendering && (
				<Card className="w-full max-w-[1200px]">
					...
					<CardContent>
						<pre className="h-[250px] whitespace-pre-wrap flex flex-col-reverse overflow-y-auto">
							{logMessages}
						</pre>
					</CardContent>
				</Card>
