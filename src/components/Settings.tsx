                    ...
                    <FieldSet>
                        <FieldGroup>
                            <FieldSet>
                                ...
                                <FieldDescription>
                                    Select the resolution of the rendered image. Larger resolutions lead to drastically
                                    longer render times.
                                </FieldDescription>
                                <RadioGroup
                            ...
                            <FieldSet>
                                ...
                                <FieldDescription>
                                    Select the number of samples that are traced per pixel. More samples lead to less
                                    noise but longer render times.
                                </FieldDescription>
                                <RadioGroup
                            ...
                            <Button
                                variant="default"
                                type="button"
                                onClick={() => render(selectedResolution * 16 / 9, selectedResolution, selectedSampleCount)}
                            >
                                Render
                            </Button>
                        </FieldGroup>
